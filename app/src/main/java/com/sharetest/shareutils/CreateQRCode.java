...
public class CreateQRCode {
    ...
    public static class CreateEnglishQRCode extends AsyncTask<Void, Void, Bitmap> {
        ImageView imageView;
        String url;
        public CreateEnglishQRCode(ImageView imageView, String url) {
        ...
        protected Bitmap doInBackground(Void... voids) {
            if(!saveUrl.equals(url)){
                saveBitmap = QRCodeEncoder.syncEncodeQRCode(url, BGAQRCodeUtil.dp2px(context, 150), Color.parseColor("#000000"),
